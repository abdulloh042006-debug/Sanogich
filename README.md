...
- ⏱️ **Planka** — to'g'ri holatda turgan vaqtingizni soniyada o'lchaydi
- 🚶 **Vipad (lunge)** — tizza burchaklari orqali sanaydi
- 🏃 **Tizza ko'tarish** — tizzaning bel darajasidan yuqoriga chiqishi orqali sanaydi
...
| Planka | Yon tomondan, tana to'liq ko'rinsin |
| Vipad | Yon tomondan, ikkala oyoq ko'rinsin |
| Tizza ko'tarish | Old tomondan, to'liq bo'y |
